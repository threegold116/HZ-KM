...
ann_file_path="/home/jiangshixin/dataset/remote_sense/RSGPT4v/Train/RS-GPT4V-Instruct.json"
image_dir="/home/jiangshixin/dataset/remote_sense/DIOR"
...
for line in data:
    ...
    new_line["image"]=os.path.join(image_dir,"/".join(line["image"].split("/")[1:]))
...
with open("/home/jiangshixin/myproject/HZ-KM/train_data/jsonfiles/rsgpt4v_train_qa_cap_test.json","w") as f:
